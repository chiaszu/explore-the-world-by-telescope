...
<head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Fredericka+the+Great&family=Merriweather:wght@300;400;700&display=swap"
      rel="stylesheet"
    />
...
<body>
  <section id = "section1">
    ...
    <!-- <a href="#othersection">
      <img style="display:inline;"id = "todown"src="todown.svg">
    </a> -->
  ...
  <section id = "othersection"style="overflow:hidden;">
    ...
    <a href = "..\readmore\readmore.php"><p id = "readmore">Read More<p></a>
    <div id = "beensofarouter">
    <p class = "beensofartext">Been So Far...</p>
    <div class = "beensofar">
      <div class="beendivs"><a id = "been1link"><img id = "been1" class = "beenimgs"src=".\homepageimg\country1.jpeg"><p id = "been1text"class = "beentextonimg">United Kingdom</p></a></div>
      <div class="beendivl"><a id = "been2link"><img id = "been2" class = "beenimgl"src=".\homepageimg\country2.jpg"><p id = "been2text" class = "beentextonimg">Germany</p></a></div>
      <div class="beendivs"><a id = "been3link"><img id = "been3" class = "beenimgs"src=".\homepageimg\country3.jpg"><p id = "been3text" class = "beentextonimg">Taiwan</p></a></div>
      <div class="beendivs"><a id = "been4link"><img id = "been4" class = "beenimgs"src=".\homepageimg\country4.jpg"><p id = "been4text" class = "beentextonimg">Japan</p></a></div>
      <div class="beendivs"><a id = "been5link"><img id = "been5" class = "beenimgs"src=".\homepageimg\other.jpeg"><p id = "been5text" class = "beentextonimg">To Be Continue</p></a></div>
    </div>
  </div>
